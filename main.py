...
bold_button = Button(toolbar_frame, borderwidth=0, image=bold_icon, command=bold)  # Ensure 'bold' function is defined
bold_button.grid(row=0, column=2, sticky=W, padx=8, pady=2)

italic_icon = ImageTk.PhotoImage(Image.open("icons/italics.png").resize((15, 15), Image.LANCZOS))
italic_button = Button(toolbar_frame, borderwidth=0, image=italic_icon, command=italic)  # Ensure 'italic' function is defined
italic_button.grid(row=0, column=3, sticky=W, padx=8, pady=2)

underline_icon = ImageTk.PhotoImage(Image.open("icons/underline.png").resize((15, 15), Image.LANCZOS))
underline_button = Button(toolbar_frame, borderwidth=0, image=underline_icon, command=underline)  # Ensure 'underline' function is defined
underline_button.grid(row=0, column=4, sticky=W, padx=8, pady=2)

strike_icon = ImageTk.PhotoImage(Image.open("icons/strike.png").resize((15, 15), Image.LANCZOS))
strike_button = Button(toolbar_frame, borderwidth=0, image=strike_icon, command=strike)  # Ensure 'strike' function is defined
strike_button.grid(row=0, column=5, sticky=W, padx=8, pady=2)

# Color text button
color_icon = ImageTk.PhotoImage(Image.open("icons/color.png").resize((18, 18), Image.LANCZOS))
color_text_button = Button(toolbar_frame, borderwidth=0, image=color_icon, command=text_color)  # Ensure 'text_color' function is defined
color_text_button.grid(row=0, column=6, padx=8, pady=2)

# Alignment buttons
left_icon = ImageTk.PhotoImage(Image.open("icons/align_left.png").resize((18, 18), Image.LANCZOS))
left_button = Button(toolbar_frame, borderwidth=0, image=left_icon, command=align_left)  # Ensure 'align_left' function is defined
left_button.grid(row=0, column=7, padx=8, pady=2)

right_icon = ImageTk.PhotoImage(Image.open("icons/align_right.png").resize((18, 18), Image.LANCZOS))
right_button = Button(toolbar_frame, borderwidth=0, image=right_icon, command=align_right)  # Ensure 'align_right' function is defined
right_button.grid(row=0, column=8, padx=8, pady=2)

center_icon = ImageTk.PhotoImage(Image.open("icons/align_middle.png").resize((18, 18), Image.LANCZOS))
center_button = Button(toolbar_frame, borderwidth=0, image=center_icon, command=align_middle)  # Ensure 'align_middle' function is defined
center_button.grid(row=0, column=9, padx=8, pady=2)

justify_icon = ImageTk.PhotoImage(Image.open("icons/align_justify.png").resize((18, 18), Image.LANCZOS))
justify_button = Button(toolbar_frame, borderwidth=0, image=justify_icon, command=align_justify)  # Ensure 'align_justify' function is defined
justify_button.grid(row=0, column=10, padx=8, pady=2)
